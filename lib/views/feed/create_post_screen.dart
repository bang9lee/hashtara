...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  void _loadChannelInfo() async {
    final channelAsync =
        await ref.read(hashtagChannelProvider(widget.channelId!).future);
  ...
  Future<void> _createHashtagChannel(String hashtag) async {
    try {
      ...
      // 채널 저장
      await ref
          .read(hashtagChannelControllerProvider.notifier)
  ...
  Future<void> _createPost() async {
    ...
    try {
      ...
      debugPrint(
          '게시물 작성 시도: 작성자 ${currentUser.id}, 내용: $caption, 해시태그: ${_selectedHashtags.join(' ')}');
                    ...
                    children: [
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(
                                  colors: [
                                    Color(
                                        0xC8785BFF), // AppColors.primaryPurple 200/255 투명도
                                    Color(
                                        0x64785BFF), // AppColors.primaryPurple 100/255 투명도
                                  ],
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(
                                  colors: [
                                    Color(
                                        0xC8537AF1), // AppColors.secondaryBlue 200/255 투명도
                                    Color(
                                        0x64537AF1), // AppColors.secondaryBlue 100/255 투명도
                                  ],
                                  begin: Alignment.topLeft,
                                  end: Alignment.bottomRight,
                                ),
                              ...
                              Wrap(
                                ...
                                children: _selectedHashtags.map((hashtag) {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: const Color(
                                          0x96785BFF), // AppColors.primaryPurple 150/255 투명도
                                      borderRadius: BorderRadius.circular(16.0),
                                      boxShadow: const [
                                        BoxShadow(
                                          color: Color(
                                              0x28785BFF), // AppColors.primaryPurple 40/255 투명도
                                          blurRadius: 6,
                                          offset: Offset(0, 2),
                                        ),
                                      ],
                      ...
                      if (_errorMessage != null)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(
                                0x28FF3B30), // CupertinoColors.systemRed 40/255 투명도
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color: const Color(
                                  0x64FF3B30), // CupertinoColors.systemRed 100/255 투명도
                              width: 1.0,
                            ),
                          ),
                          child: Row(
